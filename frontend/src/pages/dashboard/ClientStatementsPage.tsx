...
const emptyForm = { client_name: '', client_position: '', company_name: '', statement: '', rating: '5', is_published: false, is_featured: false, display_order: '0', our_client_id: '' };
